...
def encode_page(filename: str) -> tuple[str, int, int]:
    """Convert PNG to JPEG (quality 82) and return (base64, width, height)."""
...
(function() {
  ...
  function goNext() {
    ...
    if (currentPanel < 0) {
      ...
      // Last panel on this page -> full view of next page
  ...
  // Initialize: stay on full page view; user taps to walk into panels
  initViewer();
})();
</script>
</body>
